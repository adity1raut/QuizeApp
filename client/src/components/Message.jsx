...
const Message = ({ message, onDismiss }) => {
  ...
  return (
    <div className={`fixed top-4 right-4 left-4 md:left-auto z-50 animate-fade-in-down`}>
      <div className={`flex items-start p-4 rounded-lg border ${config.bg} ${config.border} backdrop-blur-sm shadow-lg max-w-md mx-auto md:mx-0`}>
