  ...
  return (
    <div className="bg-gray-900 min-h-screen flex font-sans">
      ...
      <div className={`flex flex-1 ${isAuthenticated ? 'lg:ml-0' : ''}`}>
        ...
        <div className={`hidden ${isAuthenticated ? 'lg:flex lg:w-1/2' : 'lg:flex lg:w-1/2'} bg-gradient-to-br from-gray-800 to-gray-900 relative overflow-hidden`}>
        ...
        <div className={`w-full ${isAuthenticated ? 'lg:w-1/2' : 'lg:w-1/2'} flex items-center justify-center p-8 ${isAuthenticated ? 'pt-20 lg:pt-8' : ''}`}>
            ...
            {isAuthenticated ? (
              ...
              <div className="text-center text-white">
                ...
                <p className="text-gray-400 mb-6">
                  You are currently logged in. Use the sidebar to navigate to different sections.
                </p>
