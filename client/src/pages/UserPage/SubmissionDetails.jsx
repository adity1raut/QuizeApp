    ...
    return (
      <div className="min-h-screen bg-gray-900 flex items-center justify-center">
        <div className="text-center max-w-md mx-auto p-6">
          ...
          <h3 className="text-xl font-medium text-red-400 mb-2">Submission Not Available</h3>
        ...
        <div className="bg-gray-800 rounded-xl p-6 mb-8 border border-gray-700">
          <div className="flex flex-col md:flex-row md:items-center md:justify-between">
            <div>
              ...
              <h2 className="text-xl text-blue-400 font-semibold">{submission.quiz.title}</h2>
          ...
          <div className="bg-gray-800 p-4 rounded-lg border border-gray-700">
            <div className="flex items-center">
              ...
              <div>
                ...
                <p className="text-white font-semibold text-xl">{submission.correctAnswers}</p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-gray-800 p-4 rounded-lg border border-gray-700">
            <div className="flex items-center">
              ...
              <div>
                ...
                <p className="text-white font-semibold text-xl">{submission.totalQuestions - submission.correctAnswers}</p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-gray-800 p-4 rounded-lg border border-gray-700">
            <div className="flex items-center">
              ...
              <div>
                ...
                <p className="text-white font-semibold text-xl">{submission.score}%</p>
              </div>
            </div>
          </div>
        </div>
